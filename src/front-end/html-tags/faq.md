...
To generate HTML tags around elements of your **Mobile App** and **Reactive Web App** use the **HTML Element** Widget and define the `Tag` Property. Note that the `Tag` Property has to be a constant value.  Use the `Attributes` fields to define HTML attributes.
