...
Below is the code; notice the scenario inside a Table Records %%![Unit04.png](images/unit04.png) | Below is the result of the execution; notice that many scenarios were executed %%![Unit04_result.png](images/unit04_result.png) 
---|---  
